...
\begin{itemize}
  ...
  \item {\em Class Participation\/}: All students are required to actively
    ...
    course's Slack workspace. A student will receive an interim letter grade for
    this category.
  ...
  \item {\em Project Reports\/}: Graded on either a letter-grade or a
  ...
  \item {\em Software Projects\/}: Graded on a letter-grade basis, these two
    ...
    % will present you with the description of a problem and ask you to implement,
    % document, and release a full-featured solution. The final project in this
    % class will require you to apply all of the knowledge and skills that you
    % have acquired during the semester to solve a problem and, whenever possible,
    % make your solution publicly available as a free and open-source tool. The
    % project will invite you to draw upon both your communication and problem
    % solving skills and your knowledge of programming languages and software
    % engineering tools. The final project will be completed in groups assigned by
